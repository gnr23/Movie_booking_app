...
class MovieViewModel : ViewModel() {
    ...
    //method that can generate a list of four dates that are needed to display in the DaySelectFragment UI.
    private fun getDateOptions(): List<String> {
        ...
        // Create a list of dates with the current date and the following 3 dates
        repeat(4) {
